...
import com.wildcardenter.myfab.for_jahan.helpers.Listeners;
import com.wildcardenter.myfab.for_jahan.helpers.NotificationHandler;
import com.wildcardenter.myfab.for_jahan.helpers.PlaybackManager;
import com.wildcardenter.myfab.for_jahan.helpers.UpdateReceiver;
...
public class SongService extends Service implements MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener {
    ...
    private Listeners.MediaPlayerListener mediaPlayerListener = mp -> PlaybackManager.mediaPlayerStarted(mp);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        startForeground(notifID, notificationHandler.notification);
        return START_STICKY;
    }
    ...
    public void performAction(final Intent intent) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                switch (action) {
                    case ACTION_PLAY:
                        data = intent.getStringExtra(MusicActivity.SONG_PATH);
                        title = intent.getStringExtra(MusicActivity.SONG_TITLE);
                        artist = intent.getStringExtra(MusicActivity.ARTIST_NAME);
                        album = intent.getStringExtra(MusicActivity.ALBUM_NAME);
                        try {
