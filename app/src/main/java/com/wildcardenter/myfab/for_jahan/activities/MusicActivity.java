...
import com.wildcardenter.myfab.for_jahan.helpers.AllSongListAdapter;
import com.wildcardenter.myfab.for_jahan.helpers.BitmapPalette;
import com.wildcardenter.myfab.for_jahan.helpers.PlayPauseView;
import com.wildcardenter.myfab.for_jahan.helpers.PlaybackManager;
import com.wildcardenter.myfab.for_jahan.helpers.SharedPrefHelper;
import com.wildcardenter.myfab.for_jahan.slidingtabhelper.SlidingTabLayout;
import com.wildcardenter.myfab.for_jahan.slidingtabhelper.ViewPagerAdapter;
import com.wildcardenter.myfab.for_jahan.slidinguppanelhelper.SlidingUpPanelLayout;


import java.util.HashMap;

import static com.wildcardenter.myfab.for_jahan.helpers.BitmapPalette.blurredBitmap;
import static com.wildcardenter.myfab.for_jahan.helpers.BitmapPalette.mediumBitmap;
import static com.wildcardenter.myfab.for_jahan.helpers.BitmapPalette.smallBitmap;
import static com.wildcardenter.myfab.for_jahan.helpers.SharedPrefHelper.PLAYER_KEY;
...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (helper.getData(PLAYER_KEY, TYPE_BOOLEAN).equals(false)) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                ...
                builder.create().show();
                helper.setData(PLAYER_KEY, true, TYPE_BOOLEAN);
            }
        }
        ...
        if (songAlbumbg != null) {
            if (mediumBitmap != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    getWindow().setStatusBarColor(BitmapPalette.darkVibrantRGBColor);
                }
